    ...
    struct Args {
        ...
        "Block lifetime" [
            ...
            ttl_mix: IntList {
                ...
                check: |this| {
                    ...
                    && (this.ttl_mix.unwrap_intlist().len() > 0) &&
                    (this.ttl_list.unwrap_intlist().len() != this.ttl_mix.unwrap_intlist().len()) {
                        panic!(
                            "{} Number of weights doesn't match to the number of items in lifetime list. W({}) != L({})",crate::colorize!("[ERROR]"; RED),
                            this.ttl_mix.unwrap_intlist().len(),
        ...
        "Touch/fault parameters" [
            touch_stride: Size {
                ...
                long: "touch-stride",
                metavar: "BYTES",
                help: "Step between writes when “warming” a block",
                default: 1 << 12
            }
        ],
